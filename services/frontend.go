...
func (fe *frontendServer) Run() error {
	...
	mustConnARPC(&fe.currencySvcConn, fe.currencySvcAddr, "frontend")
	mustConnARPC(&fe.productCatalogSvcConn, fe.productCatalogSvcAddr, "frontend")
	mustConnARPC(&fe.cartSvcConn, fe.cartSvcAddr, "frontend")
	mustConnARPC(&fe.recommendationSvcConn, fe.recommendationSvcAddr, "frontend")
	mustConnARPC(&fe.shippingSvcConn, fe.shippingSvcAddr, "frontend")
	mustConnARPC(&fe.checkoutSvcConn, fe.checkoutSvcAddr, "frontend")
	mustConnARPC(&fe.adSvcConn, fe.adSvcAddr, "frontend")
